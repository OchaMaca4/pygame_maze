...
#class of the main player (untuk menggerakkan)
    ...
    #   platforms_touched = sprite.spritecollide(self, barriers, False)
      ...
      if self.y_speed > 0: # going down
          ...
          for p in platforms_touched:
              ...
              # aligning the upper edge along the lower edges of the walls that were touched
...
w1 = GameSprite('rintangan.png',win_width / 2 - win_width / 3, win_height / 2, 170, 100)
w2 = GameSprite('rintangan.png', 370, 100, 90, 400)
...
#creating sprites
packman = Player('me.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('finish.png', win_width - 85, win_height - 100, 80, 80)


monster1 = Enemy('ghost.png', win_width - 80, 150, 50, 40, 5)
...
#checking that the game is not finished yet
 if not finish:
    ...
    #groupcollide digunakan untuk mengecek si mons
     ...
     if sprite.spritecollide(packman, monsters, False):
         finish = True
         #calculate the ratio
         img = image.load('kalah.png')
         d = img.get_width() // img.get_height()
         window.fill((255, 255, 255))
         window.blit(transform.scale(img, (win_height * d, win_height)), (90, 0))

     if sprite.spritecollide(packman, barriers, False):
         print('bisa')
         finish = True
         #calculate the ratio
         img = image.load('kalah.png')
